...
from subfunctions_Synthdata_neoHookean import *

mesher_filename = current_dir + '\\Cubit_Mesher\\Journal.jou'
mesh_folder = current_dir + '\\Meshes\\NeoHookean_10000'
mesh_filename = current_dir + '\\Cubit_Mesher\\Mesh.inp'

solver_filename = current_dir + '\\FEBio_Solver_NH\\jobs\\FEBioModel_1.feb'
